...
import { Box, Button, Grid, Typography, Paper, Avatar, TextField, FormControl, InputLabel } from "@mui/material";
					...
					<Paper elevation={3} sx={{ padding: "2rem", pt: 2, borderRadius: "10px" }}>
						<Grid container spacing={2}>
							...
							<Grid size={{ lg: 6, md: 6, sm: 12, xs: 12 }}>
								...
								<InputLabel sx={{fontFamily: 'poppins-semibold', width: 'fit-content', color: '#333333'}}>Select File</InputLabel>
								<FormControl fullWidth>
									<TextField
										type="file"
										slotProps={{
											htmlInput: { accept: ".png, .jpg, .jpeg, .pdf" },
										}}
										size="small"
										onChange={handleFileChange}
										sx={{ '& input': {paddingTop: '6px', paddingBottom: '11px'} }}
									/>
								</FormControl>
							</Grid>
