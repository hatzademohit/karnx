...
const OneWayFlights = () => {
  ...
  const departureTime = formData.flightDetails?.departure_time
    ? dayjs(formData.flightDetails.departure_time)
    : dayjs();
      ...
      <Grid container spacing={2}>
        ...
        <Grid item lg={4} md={4}>
          <CustomDateTimePicker
            ...
            value={departureTime}
            // This handler updates the context state directly
            onChange={(newValue) => {
              // newValue might be null, so guard against that
              setFormData({
                ...formData,
                flightDetails: {
                  ...formData.flightDetails,
